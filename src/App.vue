...
const layerHandlers = {
  satellites(viewer, value) {
    if (viewer.points) {
      viewer.points.show = value;
    }
  },
  sensors(_viewer, value) {
    for (const observatory of universeRef.value?._observatories ?? []) {
